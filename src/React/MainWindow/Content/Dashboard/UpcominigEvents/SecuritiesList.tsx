        ...
        <Card>
            <Card.Body>
                ...
                <FilterableTable<Security>
                    ...
                    title={""}
                    tableStructure={[
                        { header: "Typ", renderTdBody: (security: Security) => renderType(security.isCash), colMd: 1 },
                        {
                            header: "Oznaczenie",
                        ...
                        {
                            header: "Wartość",
                            renderTdBody: (security: Security) => renderValue(security.value),
                            colMd: 1,
                        },
                        {
                            header: "Zwrócono",
                            renderTdBody: (security: Security) => renderValue(security.returnedValue),
                            colMd: 1,
                        },
                        {
                            header: "Do zwrotu",
                            renderTdBody: (security: Security) => renderValue(security._remainingValue),
                            colMd: 1,
                        },
                        {
                            header: "70% Wygasa",
                        ...
                        {
                            header: "Uwagi",
                            renderTdBody: (security: Security) => renderDescription(security),
                            colMd: 2,
                        },
                    ]}
                    isDeletable={true}
