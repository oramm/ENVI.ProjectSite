class CaseModal extends Modal {
    constructor(id, tittle, connectedResultsetComponent, mode){
        ...
        //this.typeSelectField.initialise(MeetingsSetup.caseTypesRepository.items, 'name');
        this.formElements = [
            {   input: this.typeSelectField,
                dataItemKeyName: '_type',
                refreshDataSet: function (){
                    var currentCaseTypes = MeetingsSetup.caseTypesRepository.items.filter(
                ...
                checkCaseType(caseTypeItem){
                    ...
                    return allowType;//caseTypeItem.milestoneTypeId==MeetingsSetup.currentMilestone._type.id;
     ...
     */
    initAddNewData(){
        this.connectedResultsetComponent.connectedRepository.currentItem = { _parent: MeetingsSetup.currentMilestone,
                                                                             _processesInstances: []
                                                                           };
    }
};