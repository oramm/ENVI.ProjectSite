function getMeetingArrangementsList(initParamObject, externalConn?: GoogleAppsScript.JDBC.JdbcConnection) {
...
function getMeetingArrangementsListPerProject(projectOurId: string) {
  return getMeetingArrangementsList({ projectOurId: projectOurId });
}

function getMeetingArrangementsListPerContract(contractId: number) {
  return getMeetingArrangementsList({ contractId: contractId });
}

function getMeetingArrangementsListPerMeeting(meetingId: number) {
...
function getMeetingArrangements(sql: string, externalConn?: GoogleAppsScript.JDBC.JdbcConnection) {
  try {
    Logger.log(sql);
    var result = [];
