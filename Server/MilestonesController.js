function getMilestonesListPerProject(initParamObject) {
  ...
  try {
    ...
    while (dbResults.next()) {
      var item = new Milestone({id: dbResults.getLong('Id'),
                                ...
                                _parent: new Contract ({id: dbResults.getLong('ParentId'),
...
function getCurrentMilestonesList() {
  var currentUserSystemRole = Setup.getSystemRole();
...
function addNewMilestone(itemFromClient) {
  ...
  var contract = new Contract(item._parent);
  ...
  try{
    ...
    var defaultItems = item.createDefaultCasesInDb({foldersGdData: milestoneFolders, 
                                                    externalConn: conn, 
...
function editMilestone(itemFromClient) {
  ...
  var parentContract = new Contract(item._parent);
