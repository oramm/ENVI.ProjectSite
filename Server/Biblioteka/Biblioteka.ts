...
Tools.inheritPrototype = function (childObject, parentObject) {
...
function createZip(obj, parentFolderGdId) {
...
function makeIdsListString(objectList) {
 ...
 * }
 */
Tools._blobEnviObjectToBlob = function (_blobEnviObject) {
...
Tools.enumFieldsToArray = function (enumToParse): { key: string, value: any }[] {
...
function test_enumFieldsToArray() {
  var array = Tools.enumFieldsToArray(OurLettersSetup.CommonLetter.namedRangeData);
  Logger.log(array);
}