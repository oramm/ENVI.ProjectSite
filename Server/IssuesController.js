  ...
  try {
    ...
    while (dbResults.next()) {
      var item = { id: dbResults.getLong(1),
                   ...
                   _owner: {id: dbResults.getString(12)},
                   _parent: { id: dbResults.getString(3),
      ...
      name = (dbResults.getString(17))? dbResults.getString(17): '';
      surname = (dbResults.getString(18))? dbResults.getString(18): '';
      if (name)
...
function getCurrentIssuesList() {
  ...
  try {  
    ...
    var dbResults = stmt.executeQuery(sql);
    while (dbResults.next()) {
      var item = {id: dbResults.getLong('Id'),
                  name: dbResults.getString(2),
                  ...
                  _lastUpdated: dbResults.getString(11),
                  _owner: {id: dbResults.getLong(12)},
                  _parent: {id: dbResults.getLong(3),
                            _gdFolderUrl: 'https://drive.google.com/drive/folders/' + dbResults.getString(15),
                            ourId: dbResults.getString(16),
                            projectId: dbResults.getString(14)
                            //_manager: {id: dbResults.getString(10)},
