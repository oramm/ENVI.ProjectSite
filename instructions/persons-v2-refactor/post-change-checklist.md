...
- [ ] [instructions/persons-v2-refactor/persons-v2-refactor-progress.md](instructions/persons-v2-refactor/persons-v2-refactor-progress.md) ma finalny wpis `DONE`.
