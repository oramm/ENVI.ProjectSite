...
var OurOldTypeLetterModal = /** @class */ (function (_super) {
    __extends(OurOldTypeLetterModal, _super);
    function OurOldTypeLetterModal(id, title, connectedResultsetComponent, mode) {
        var _this_1 = _super.call(this, id, title, connectedResultsetComponent, mode) || this;
        _this_1.controller = new OurOldTypeLetterModalController(_this_1);
        _this_1.doChangeFunctionOnItemName = '';
        _this_1.doAddNewFunctionOnItemName = '';
    ...
    OurOldTypeLetterModal.prototype.initFormElements = function () {
     ...
     */
    OurOldTypeLetterModal.prototype.initAddNewData = function () {
        this.controller.initAddNewDataHandler();
    };
    return OurOldTypeLetterModal;
}(LetterModal));
