...
var CaseModal = /** @class */ (function (_super) {
    ...
    function CaseModal(id, title, connectedResultsetComponent, mode) {
        ...
        var _this = _this_1;
        _this_1.typeSelectField = new SelectField(_this_1.id + 'typeSelectField', 'Typ sprawy', undefined, false);
        ...
        _this_1.formElements = [
            {
                ...
                refreshDataSet: function () {
                    var _this_1 = this;
                    var currentCaseTypes = MainSetup.caseTypesRepository.items.filter(function (item) { return _this_1.checkCaseType(item); });
                ...
                checkCaseType: function (caseTypeItem) {
                    ...
                    if (caseTypeItem.isUniquePerMilestone)
                        MeetingsSetup.casesRepository.items.map(function (existingCaseItem) {
