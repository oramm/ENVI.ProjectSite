...
function ApplicationCallModalBody({ isEditing, initialData }) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(react_bootstrap_1.Form.Group, { controlId: "description" },
            ...
            react_1.default.createElement(react_bootstrap_1.Form.Control, { as: "textarea", rows: 3, placeholder: "Podaj opis", isInvalid: !!errors?.description, ...register("description") }),
        ...
        react_1.default.createElement(react_bootstrap_1.Form.Group, { controlId: "url" },
            ...
            react_1.default.createElement(react_bootstrap_1.Form.Control, { type: "text", placeholder: "Podaj URL", isInvalid: !!errors?.url, ...register("url") }),
        ...
        react_1.default.createElement(react_bootstrap_1.Form.Group, { controlId: "startDate" },
            ...
            react_1.default.createElement(react_bootstrap_1.Form.Control, { type: "date", isInvalid: !!errors?.startDate, ...register("startDate") }),
        ...
        react_1.default.createElement(react_bootstrap_1.Form.Group, { controlId: "endDate" },
            ...
            react_1.default.createElement(react_bootstrap_1.Form.Control, { type: "date", isInvalid: !!errors?.endDate, ...register("endDate") }),
        ...
        react_1.default.createElement(react_bootstrap_1.Form.Group, { controlId: "focusAreaId" },
            react_1.default.createElement(react_bootstrap_1.Form.Label, null, "Obszar interwencji"),
            react_1.default.createElement(CommonFormComponents_1.FocusAreaSelector, { repository: FocusAreasController_1.focusAreasRepository, showValidationInfo: true, ...register("focusAreaId") }),
            react_1.default.createElement(CommonFormComponents_1.ErrorMessage, { name: "focusAreaId", errors: errors }))));
}
