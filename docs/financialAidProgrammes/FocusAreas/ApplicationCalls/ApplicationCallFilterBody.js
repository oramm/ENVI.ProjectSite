...
function ApplicationCallsFilterBody() {
    ...
    return (react_1.default.createElement(react_bootstrap_1.Row, null,
        ...
        react_1.default.createElement(react_bootstrap_1.Form.Group, { as: react_bootstrap_1.Col, md: 6, controlId: "focusAreaId" },
            react_1.default.createElement(react_bootstrap_1.Form.Label, null, "Obszar interwencji"),
            react_1.default.createElement(CommonFormComponents_1.FocusAreaSelector, { repository: FocusAreasController_1.focusAreasRepository, showValidationInfo: false, ...register("focusAreaId") }))));
}
