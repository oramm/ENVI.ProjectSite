    ...
    for (const task of tasks) {
        ...
        if (!contractNode) {
            ...
            contractNode = {
                ...
                level: 1,
                type: nodeName,
                repository: TasksGlobalController_1.contractsWithChildrenRepository,
                dataItem: contract,
